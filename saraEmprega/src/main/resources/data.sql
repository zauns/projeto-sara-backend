...
(
    ...
    '$2a$04$7uuQIXKVtnEzGqFZnoPDBeaoYfeoYCgbNzrr2JuYULt9g5WBRRW0G', -- Hash: admin123
    'Fulano Super Admin',
    1,
    'Rua do Alto, 100',
    '123456789',
...
(
    UUID_TO_BIN(UUID()),
    'empresa@sara.com',
    '$2a$04$pSTzM3acOzgvkRtzwy4fMOgjqziA5g8M/6j9HugC/57zp9bJ/8Qyq', -- Hash: senha123
    'Empresa Padrão Ltda',
    'Av. Empresarial, 300',
    '8133334444',
    '92.167.491/0001-88',
...
INSERT INTO user
(id, email, senha_hash, nome, endereco, telefone, cpf, data_nascimento, tipo)
VALUES
(
    UUID_TO_BIN(UUID()),
